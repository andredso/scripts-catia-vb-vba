VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmFracionamento
   Caption         =   "Fracionamento de Fitas Adesivas em Rolo"
   ClientHeight    =   8040
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9825
   OleObjectBlob   =   "frmFracionamento.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmFracionamento"
...
Private Sub Salva_Numero_Lote()
    ...
    With WS_1
        ...
        .Protect "neo2023", DrawingObjects:=True, Contents:=True, Scenarios:=True
    End With
    Set WS_1 = Nothing
    WB_1.Save
    Set WB_1 = Nothing
